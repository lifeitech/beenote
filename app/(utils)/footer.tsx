    ...
    <footer className="footer footer-center p-10 bg-primary text-primary-content">
      ...
      <div>
        <div className="grid grid-flow-col gap-4">
          <a href="mailto:fei.li.best@outlook.com">
          ...
          <a href="https://www.linkedin.com/in/lifeipro" target="_blank" rel="noreferrer">
          ...
          <a href="https://github.com/lifeitech" target="_blank" rel="noreferrer">
